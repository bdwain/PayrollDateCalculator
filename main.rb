...
if ARGV.include? "help"
  ...
  puts "     weekly: pays every friday"
  puts "     bi_weekly: pays every other friday, starting with the first friday after start_date"
  puts "     semi_monthly: pays on the 15th and the last day of every month. if those days are on a weekend or holiday, it pays on the last valid day before it"
  puts "     monthly: pays on the last day of every month. if those days are on a weekend or holiday, it pays on the last valid day before it"
